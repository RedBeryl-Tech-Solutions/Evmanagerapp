...
public class SubscriptionDetails implements Serializable {
    ...
    private ZonedDateTime subscriptionExpiryDate;
    ...
    public SubscriptionDetails subscriptionStartDate(ZonedDateTime subscriptionStartDate) {
    ...
    public ZonedDateTime getSubscriptionExpiryDate() {
        return this.subscriptionExpiryDate;
    }

    public SubscriptionDetails subscriptionExpiryDate(ZonedDateTime subscriptionExpiryDate) {
        this.setSubscriptionExpiryDate(subscriptionExpiryDate);
        return this;
    }

    public void setSubscriptionExpiryDate(ZonedDateTime subscriptionExpiryDate) {
